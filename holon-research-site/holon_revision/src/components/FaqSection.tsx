...
export function FaqSection() {
  ...
  return (
    <section id="faq" aria-labelledby="faq-title" className="border-t border-hairline-soft pt-10 md:pt-16">
      <div className="grid grid-cols-1 gap-x-16 gap-y-8 md:grid-cols-12">
        <div className="md:col-span-4">
          <h2
            id="faq-title"
            className="font-display text-[2.25rem] font-light leading-tight tracking-tight text-ink md:text-[3rem] md:sticky md:top-28">
                  ...
                  <AnimatePresence initial={false}>
                    ...
                    <motion.div
                      ...
                      className="overflow-hidden">
                        ...
                        <p className="max-w-xl pb-6 pr-12 text-[15px] leading-[1.75] text-ink-soft">
                          {item.answer}
                        </p>
                      </motion.div>
                    }
